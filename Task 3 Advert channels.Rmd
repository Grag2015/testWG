...
(все детали доступны [по ссылке](https://github.com/Grag2015/testWG/blob/master/Task%203%20Advert%20channels.Rmd))
...
**Результат:** т.о. спрогнозированное на июнь количество регистраций равно `r round(fitted.values(fit)[12]-fitted.values(fit)[1]+100,2)`
